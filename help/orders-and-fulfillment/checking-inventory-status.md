...
Nauwkeurigheid met inventarisatie is een zeer belangrijke overweging. Er zijn enkele native functies die kunnen helpen ervoor te zorgen dat dit risico zo laag mogelijk is, zoals back orders en het vaststellen van de drempel voor het buiten de voorraad houden. Beide onderwerpen kunnen worden gelezen [Experience League](https://experienceleague.adobe.com/en/docs/commerce-admin/inventory/configuration/backorders) voor nadere uitleg.
