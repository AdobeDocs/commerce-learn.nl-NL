...
Wanneer het tijd is aan cutover, gelieve de volgende stappen (voor meer informatie, zie ](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/launch/checklist) DNS Configuraties {target="_blank"}) uit te voeren:[
