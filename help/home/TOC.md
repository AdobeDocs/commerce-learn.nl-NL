...
+ Aan de slag {#getting-started}
   ...
   + Commerce-mogelijkheden {#capabilities}
      + [Beschikbare handelsopties](../capabilities/adobes-available-commerce-options.md)
   ...
   + Startkit voor de integratie van back office {#back-office-integration-starter-kit}
      ...
      + [Webhook-opname](../back-office-integrations/webhook-ingestion.md)
...
+ Uitbreidbaarheid {#extensibility}
   ...
   + Adobe Developer App Builder {#adobe-developer-app-builder}
      ...
      + Aangepaste verzendsnelheden maken met AI-tools {#custom-shipping-rates-ai-tools}
         + [Inleiding en installatie](../app-builder/custom-shipping-rates-ai-tools/introduction-setup.md)
         + [AI-gereedschappen en Adobe-startkit](../app-builder/custom-shipping-rates-ai-tools/ai-tools-starter-kit.md)
         + [Implementatie en testen](../app-builder/custom-shipping-rates-ai-tools/implementation-testing.md)
         + [Feedback geven aan Adobe](../app-builder/custom-shipping-rates-ai-tools/feedback.md)
