...
# Source-codeorganisatie voor de Adobe Starter Kit
...
* Leer het belang om de code in de `starter-kit-info` omslag niet te veranderen, die een runtime actie bevat die door Adobe wordt gebruikt om projectplaatsingen te volgen die op de starter uitrusting worden gebaseerd. &#x200B;
