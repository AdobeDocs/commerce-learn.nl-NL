---
title: Een cadeaukaartproduct maken
description: Leer hoe u een cadeaukaartproduct maakt met de REST API en de Commerce Admin.
kt: 14587
doc-type: video
audience: all
activity: use
...
Leer hoe u een cadeaukaartproduct maakt met de REST API en de Adobe Commerce Admin.
...
In het volgende aanvraagvoorbeeld ziet u de payload om een cadeau-kaart te maken, zoals in de video wordt getoond. Deze kleinere lading treedt de standaardmontages voor een ondergroep van de beschikbare attributen met voeten. De overige kenmerken die niet in de lading zijn opgenomen, blijven op de standaardwaarden ingesteld.
...
- [&#x200B; creeer een product van de cadeaukaart van Commerce Admin &#x200B;](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/types/product-gift-card-create.html?lang=nl-NL){target="_blank"} 
